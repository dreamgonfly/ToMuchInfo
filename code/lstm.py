...
# User options
args.add_argument('--model', type=str, default='LSTMClassifier', choices=['WordCNN', 'VDCNN','BiLSTM','LSTMClassifier'])
args.add_argument('--tokenizer', type=str, default='TwitterTokenizer', choices=['JamoTokenizer','DummyTokenizer','TwitterTokenizer'])
...
args.add_argument('--max_length', type=int, default=120)
