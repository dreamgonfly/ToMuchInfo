...
class BiLSTM(nn.Module):
    ...
    def init_hidden(self):
        ...
        return (autograd.Variable(torch.zeros(self.layer_number, self.batch_size * 2, self.hidden_dim)).cuda(),
                autograd.Variable(torch.zeros(self.layer_number, self.batch_size * 2, self.hidden_dim)).cuda())
